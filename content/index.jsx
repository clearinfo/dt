...
class ZmitiContentApp extends Component {
	...
	render() {
		...
		switch (this.props.theme) {
			...
			<div style={{width:'100%'}}>
			<div className={'zmiti-dangjian-score-C ' + this.state.levelcss} >
			...
			<div className='zmiti-team'>出品：陈凯星、叶俊东</div>
			<div className='zmiti-team'>监制：齐慧杰、孙爱东</div>
			<div className='zmiti-team'>统筹：宋君毅</div>
			<div className='zmiti-team'>试题编辑：王静、孟洁、侯帮兴、郭兴</div>
